...
const EventWishList = lazy(() => import("../views/wishlist/EventWishList"));
const ChildWishList = lazy(() => import("../views/wishlist/ChildWishList"));
...
const Routers = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: "event-wishlist", element: <EventWishList /> },
            { path: "child-wishlist", element: <ChildWishList /> },
